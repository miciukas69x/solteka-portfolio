...
const translations = {
  ...
  lt: {
    ...
    "about.mission.content": "Teikiame aukštos kokybės paslaugas: svetainių kūrimą, rinkodarą, kūrybinę gamybą ir finansinę analizę. Mūsų misija paprasta: teikti išskirtinį darbą, kurio verta kiekvienas centas. Siūlome platų paslaugų spektrą, nes suprantame, kad verslams reikia daugiau nei vieno dalyko—o kai dirbate su mumis, gaunate kokybę, ne trumpinius.",
    "about.vision.title": "Mūsų vizija",
    "about.vision.content": "Augame kartu su klientais. Mūsų vizija—tapti jūsų pagrindine komanda, nuo kurios nenorite atsisiryti, nes kokybė tokia gera. Kai teikiame geriausią darbą, klientai lieka. O kai klientai lieka, augame kartu. Taip visi uždirbame tikrų pinigų: kurdami ilgalaikius partnerystės ryšius, ne greitus sandorius.",
    "about.why.title": "Kodėl rinktis mus?",
    "about.why.point1.title": "Kokybė pirmiausia, visada",
    "about.why.point1.content": "Geriau užtruksime savaitę ilgiau, bet padarysime teisingai, nei skubėsime ir pristatysime kažką, kas neveikia. Kai samdote mus, gaunate komandą, kuri tikrai žino, ką daro—ne agentūras, kurios pažada SEO galimybes, bet pristato tuščius puslapius, kai paieškos sistemos juos peržiūri. Mes kuriate sprendimus, kurie veikia, o ne tik gerai atrodo. Mes čia ne dėl greito pelno—mes čia, kad padidintume kompanijas, kurios jau uždirba. Jei reikia greito sprendimo, turime Simple Hustle pasiūlymus. Bet jei norite augti, mes esame komanda, kuri tikrai pristato.",
    ...
    "about.frameworks.react.desc": "Kuriame dinamiškas, komponentais paremtas aplikacijas su React. Perpanaudojami komponentai, būsenos valdymas ir našumas greitoms, mastymosi sistemoms.",
    ...
    "about.frameworks.typescript.desc": "Visas kodas rašomas TypeScript kalba dėl patikimumo ir priežiūros. Mažiau klaidų, lengvesnis refaktoringas ir pasitikėjimas diegiant atnaujinimus.",
    ...
    "about.frameworks.databases.desc": "Dirbame su PostgreSQL, MongoDB ir daugiau saugiam duomenų saugojimui. Optimizuotos schemos, tinkamas indeksavimas ir mastymosi sprendimai.",
    ...
    "about.frameworks.seo.desc": "Techniniai auditus, puslapio optimizavimas ir kokybiškos atgalinės nuorodos. Tikros pozicijos, ne tuščios metrikos.",
    ...
    "about.frameworks.video.desc": "Profesionalūs vaizdo įrašai—produktų demonstracijos, atsiliepimai, paaiškinimo vaizdo įrašai. Kokybiška įranga ir montažas, konvertuojantys žiūrovus.",
    "about.frameworks.editing.desc": "Poliruotas vaizdo montažas, atkreipiantis dėmesį į tempą, spalvų gradaciją ir istorijos pasakojimą. Nuo socialinių klipų iki pilnų promocinių vaizdo įrašų.",
    "about.frameworks.content.desc": "Tinklaraščio įrašai, socialinių tinklų turinys ir rinkodaros tekstai, atitinkantys jūsų prekės ženklo balsą ir varantys veiksmą.",
    ...
    "about.frameworks.consulting.desc": "Strateginis finansinis vadovavimas jūsų verslui. Padedame suprasti skaičius, planuoti biudžetus ir priimti pagrįstus mastymosi sprendimus.",
