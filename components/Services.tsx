  ...
  en: [
    {
      ...
      bullets: [
        ...
        "Ideal for cafes, barbers, small services. Typically launched in 3–7 days.",
      ],
    ...
    },
    {
      ...
      bullets: [
        ...
        "Best for businesses ready to invest in paid traffic and track real results.",
      ],
  ...
  lt: [
    {
      ...
      bullets: [
        ...
        "Tinka kavinėms, kirpykloms, smulkioms paslaugoms. Paprastai paleidžiame per 3–7 dienas.",
      ],
    ...
    },
    {
      ...
      bullets: [
        ...
        "Tinka verslams, kurie pasiruošę investuoti į mokamą srautą ir stebėti tikrus rezultatus.",
      ],
