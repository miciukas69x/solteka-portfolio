...
> = {
  en: {
    ...
    "ecommerce-shop": {
      ...
      tagline: "Complete online stores that sell products, not just showcase them.",
      description:
        "Full-featured e-commerce solutions with Shopify integration. Perfect for businesses ready to sell products online with payment processing, inventory management, and order fulfillment.",
      features: [
      ...
      process: [
        "Discovery call to understand your products and goals",
        "Store structure and design planning",
        "Shopify setup, product import, and customization",
    ...
    "tiktok-ads": {
      ...
      title: "TikTok Ads",
      tagline: "Creative video campaigns that reach Gen Z and drive real engagement.",
      description:
        "TikTok advertising campaigns focused on creative video content that resonates with younger audiences. Perfect for brands targeting Gen Z and Millennials through authentic, engaging video ads.",
      features: [
        "Video ad creative development and production",
      ...
      process: [
        "Kick-off call and audience research",
        "Creative concept development",
        "Video production and editing",
        "Campaign setup and launch",
        "Ongoing optimization and reporting",
      ],
      pricing: "Starting at 400 €/month + ad spend",
      timeline: "Ongoing monthly service",
      badge: "Trending",
      hasPayment: false,
    },
  ...
  lt: {
    ...
    "ecommerce-shop": {
      ...
      tagline: "Pilnai funkcionalios internetinės parduotuvės, kurios parduoda produktus, o ne tik juos demonstruoja.",
      description:
        "Pilnai funkcionalūs e-commerce sprendimai su Shopify integracija. Tinka verslams, kurie nori parduoti produktus internete su mokėjimų apdorojimu, inventoriaus valdymu ir užsakymų vykdymu.",
      features: [
        "Shopify parduotuvės sukūrimas ir pritaikymas",
        "Produktų katalogo ir inventoriaus valdymas",
        "Mokėjimo sistemos integracija (Stripe, PayPal ir kt.)",
        "Pristatymo ir mokesčių konfigūracija",
        "Užsakymų valdymo ir sekimo sistema",
        "Mobiliai optimizuota apsipirkimo patirtis",
        "SEO optimizacija produktų puslapiams",
      ],
      process: [
        "Įvadinis pokalbis ir produktų bei tikslų supratimas",
        "Parduotuvės struktūros ir dizaino planavimas",
        "Shopify sukūrimas, produktų importas ir pritaikymas",
        "Mokėjimų ir pristatymo konfigūracija",
        "Testavimas, paleidimas ir mokymas",
      ],
      pricing: "Nuo 1200 €",
    ...
    "fully-custom": {
      ...
      timeline: "Apskaičiuojama individualiai",
      badge: "Premium",
      hasPayment: true,
    },
    "meta-ads": {
      ...
      pricing: "Nuo 300 €/mėn. + reklamos biudžetas",
    ...
    "tiktok-ads": {
      ...
      tagline: "Kūrybinės vaizdo kampanijos, pasiekiančios Gen Z ir skatinančios tikrą įsitraukimą.",
      description:
        "TikTok reklaminės kampanijos, orientuotos į kūrybinį vaizdo turinį, kuris atsiliepia jaunesnei auditorijai. Tinka prekės ženklams, kurie siekia pasiekti Gen Z ir Millennial auditoriją per autentišką, įtraukiančią vaizdo reklamą.",
      features: [
        "Vaizdo reklamų kūrybos kūrimas ir gamyba",
        ...
        "Tendencijomis paremtos turinio strategijos",
      ],
      process: [
        "Pradžios skambutis ir auditorijos tyrimas",
        "Kūrybinės koncepcijos kūrimas",
        "Vaizdo įrašų gamyba ir montažas",
        "Kampanijų sukūrimas ir paleidimas",
        "Nuolatinis optimizavimas ir ataskaitos",
      ],
      pricing: "Nuo 400 €/mėn. + reklamos biudžetas",
      timeline: "Tęstinė mėnesinė paslauga",
      badge: "Populiaru",
      hasPayment: false,
    },
...
const SolutionDetailClient = ({ slug }: SolutionDetailClientProps) => {
